...
export default function DesignA() {
  return (
    <div style={{ background: C.white, color: C.text, fontFamily: "'Noto Sans JP', sans-serif" }}>
      ...
      {/* ══ HERO ══════════════════════════════════════════════ */}
      {/* 全画面写真 ＋ 中央に白いブランド名 — Okinawa Nature Office スタイル */}
      <section style={{ position: 'relative', height: 'calc(100vh - 116px)', overflow: 'hidden' }}>
        <ImageWithFallback
          src="https://images.unsplash.com/photo-1759871417753-04b770500a66?w=1800&q=85"
          alt="奄美の青い海でカヤック体験"
          style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 60%' }}
        />

        {/* Very subtle overlay — keep photo bright */}
        <div style={{
          position: 'absolute', inset: 0,
          background: 'linear-gradient(180deg, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.1) 40%, rgba(0,0,0,0.35) 100%)',
        }} />

        {/* Centered brand mark — white on photo */}
        <div style={{
          position: 'absolute', inset: 0,
          ...
          <div style={{
            ...
            AMAMI<br />NATURE GUIDE
          </div>
          <div style={{
            color: 'rgba(255,255,255,0.82)', fontSize: 'clamp(13px, 1.4vw, 16px)',
            marginTop: '18px', letterSpacing: '0.06em', lineHeight: 1.7,
        ...
        <div style={{
          ...
          <span style={{ fontFamily: "'Cabin', sans-serif", fontSize: '10px', letterSpacing: '0.2em' }}>SCROLL</span>
          <ChevronDown size={16} />
        </div>
      </section>
      ...
      {/* ══ FAQ ══════════════════════════════════════════════ */}
      <section id="faq" style={{ padding: '96px 6%', background: C.white }}>
        <div style={{ maxWidth: '860px', margin: '0 auto' }}>
          ...
          <Accordion type="single" collapsible>
            {FAQS.map((item, i) => (
              <AccordionItem key={i} value={`a-${i}`} style={{ borderColor: 'rgba(62,140,42,0.15)' }}>
                <AccordionTrigger style={{
                  fontSize: '15px', color: C.text,
                  fontWeight: 500, padding: '22px 4px', lineHeight: 1.6,
                }}>
                  {item.q}
                </AccordionTrigger>
                <AccordionContent style={{
                  fontSize: '14px', color: C.textLight,
                  lineHeight: 2.1, padding: '0 4px 22px',
                }}>
                  {item.a}
                </AccordionContent>
              </AccordionItem>
